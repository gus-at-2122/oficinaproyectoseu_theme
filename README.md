# <a href="http://wpemerge.com"><img src="https://docs.wpemerge.com/_images/wpemerge-theme-logo-bar.png" height="61" alt="OpeGandia theme Logo" aria-label='WPEmerge.com' /></a>
...
_This is the OpeGandia theme project - for the WP Emerge framework please check out https://github.com/htmlburger/wpemerge._
...
- Autoloading for all classes in your `OpeGandia\` namespace.
...
Add PHP class files here. All clases in the `OpeGandia\` namespace are autoloaded in accordance with [PSR-4](http://www.php-fig.org/psr/psr-4/).
...
OpeGandia theme is completely open source and we encourage everybody to participate by:
