 ...
 * WARNING: Do not use \OpeGandia::route()->all() here, otherwise you will override
...
// phpcs:ignore
// \OpeGandia::route()->get()->where( 'admin', 'my-custom-admin-page-slug' )->handle( 'ExampleController@admin' );
