...
class AssetsServiceProvider implements ServiceProviderInterface
{
	...
	public function enqueueFrontendAssets() {
		...
		// Enqueue scripts.
		\OpeGandia::core()->assets()->enqueueScript(
			'theme-js-bundle',
			\OpeGandia::core()->assets()->getBundleUrl( 'frontend', '.js' ),
			[ 'jquery' ],
			true
		);

		// Enqueue styles.
		$style = \OpeGandia::core()->assets()->getBundleUrl( 'frontend', '.css' );

		if ( $style ) {
			\OpeGandia::core()->assets()->enqueueStyle(
				'theme-css-bundle',
				$style
			);
		}
		...
		\OpeGandia::core()->assets()->enqueueStyle( 'theme-styles', get_template_directory_uri() . '/style.css' );
	}
	...
	public function enqueueAdminAssets() {
		...
		\OpeGandia::core()->assets()->enqueueScript(
			...
			\OpeGandia::core()->assets()->getBundleUrl( 'admin', '.js' ),
			[ 'jquery' ],
			true
		);

		// Enqueue styles.
		$style = \OpeGandia::core()->assets()->getBundleUrl( 'admin', '.css' );
	...
	public function enqueueLoginAssets() {
		...
		\OpeGandia::core()->assets()->enqueueScript(
			...
			\OpeGandia::core()->assets()->getBundleUrl( 'login', '.js' ),
			[ 'jquery' ],
			true
		);

		// Enqueue styles.
		$style = \OpeGandia::core()->assets()->getBundleUrl( 'login', '.css' );
	...
	public function enqueueEditorAssets() {
		...
		\OpeGandia::core()->assets()->enqueueScript(
			...
			\OpeGandia::core()->assets()->getBundleUrl( 'editor', '.js' ),
			[ 'jquery' ],
			true
		);
	}
	...
	public function addFavicon() {
		\OpeGandia::core()->assets()->addFavicon();
	}
